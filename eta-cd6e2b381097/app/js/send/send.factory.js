System.register([], function(exports_1, context_1) {
    ...
    function SendFactory($http, $log, $location, ngToast) {
        var SendFactory = {};
        ...
        SendFactory.base64DecToArr = function (sBase64, nBlocksSize) {
            var sB64Enc = sBase64.replace(/[^A-Za-z0-9\+\/]/g, ''), nInLen = sB64Enc.length, nOutLen = nBlocksSize ? Math.ceil((nInLen * 3 + 1 >> 2) / nBlocksSize) * nBlocksSize : nInLen * 3 + 1 >> 2, taBytes = new Uint8Array(nOutLen), nMod3, nMod4, nUint24 = 0, nOutIdx = 0, nInIdx = 0;
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("default",SendFactory);
        }
    }
});
//# sourceMappingURL=send.factory.js.map