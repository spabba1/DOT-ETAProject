System.register([], function(exports_1, context_1) {
    ...
    function EstimateController($compile, $filter, $http, $location, $log, $q, $rootScope, $scope, $stateParams, $uibModal, CreateFactory, DeleteFactory, EstimateFactory, ngToast, SecurityFactory, StaffFactory) {
        var EstimateCtrl = this;
        EstimateCtrl.taform = {};
        ...
        EstimateCtrl.addFincode = function () {
            EstimateFactory.getFCodeBean().then(function (fcResponse) {
                var i = EstimateCtrl.fcodes.length;
                EstimateCtrl.fcodes[i] = fcResponse.data;
            });
        };
        EstimateCtrl.delFinCode = function (fcode) {
            var index = EstimateCtrl.fcodes.indexOf(fcode);
        ...
        EstimateCtrl.addExpense = function () {
            EstimateFactory.getExpenseBean().then(function (expResponse) {
                var i = EstimateCtrl.expenses.length;
                EstimateCtrl.expenses[i] = expResponse.data;
            });
        };
        EstimateCtrl.delExpense = function (expense) {
            var index = EstimateCtrl.expenses.indexOf(expense);
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("default",EstimateController);
        }
    }
});
