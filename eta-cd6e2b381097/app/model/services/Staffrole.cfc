<cfcomponent displayName="Staff_roleService" output="false"
	...
	<cffunction name="init" access="public" output="false" returnType="struct"
		...
		<cfset variables.instance.staff_roleDao = new model.dao.Staffrole().init()>
		<cfset variables.instance.staff_roleGateway = new model.gateway.Staffrole().init()>
	...
	<!--- Gateway Methods --->
	<cffunction name="getAllStaff_role" access="remote" output="false" returnType="query"
