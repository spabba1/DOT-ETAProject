<cfcomponent accessors="true" output="false" extends="model.services.CoreUtils"
	...
	<cffunction name="init" access="public" output="false" returnType="model.dao.Eta_log"
	...
	<cffunction name="read" access="public" output="false" returnType="boolean"
		...
		<cfargument name="eta_log" required="true" type="model.beans.Eta_log">
	...
	<cffunction name="delete" access="public" output="false" returnType="boolean" hint="I delete a Eta_log from the database.">
	...
	<cffunction name="save" access="public" output="false" returnType="string"
	    ...
	    <cfif exists(arguments.eta_log)>
	        <cfset success = update(arguments.eta_log)>
	    <cfelse>
	        <cfset success = create(arguments.eta_log)>
		</cfif>
	    <cfreturn success>
	</cffunction>
	...
	<cffunction name="create" access="private" output="false" returnType="boolean"
		...
		<cfargument name="eta_log" required="true" type="model.beans.Eta_log"
				hint="I am the Eta_log bean.">

		<cfset var qInsert = new Query()>
		<cfset var insertResult = 0>

		<cfdump var="#eta_log#" abort>
			...
			<cftry>
				<cfquery name="qInsert" result="insertResult">
					...
					(
						...
						<cfif len(trim(#arguments.eta_log.getCreated()#))>
