<cfcomponent accessors="true" displayName="TrwtypesGateway" output="false" extends="model.services.CoreUtils"
	hint="I am the Trwtypes Gateway Class.">

	<cffunction name="init" access="public" output="false" returnType="any"
		hint="I am the constuctor method for the Trwtypes Gateway Class.">

		<cfreturn this>
	</cffunction>

	<!--- Public Methods --->
	<cffunction name="getAllTrwtypes" access="public" output="false" returnType="query"
		hint="I run a query of all TRWTYPES within the database table.">

		<cfset var qAllTRWTYPES = "">
		<cfquery name="qAllTrwtypes">
			SELECT
				ID,
				NAME
			FROM TRWTYPES
		</cfquery>
		<cfreturn qAllTrwtypes>
	</cffunction>

	<cffunction name="filterById" access="public" output="false" returnType="array"
		hint="I query the database to find a Trwtypes with a matching Id.">
		...
		<cfreturn filterAllTrwtypes(stuFilter)>
	</cffunction>

	<cffunction name="filterByName" access="public" output="false" returnType="array"
		hint="I query the database to find a Trwtypes with a matching Name.">
	...
	<cffunction name="filterAllTrwtypes" access="private" output="false"
