component extends="mxunit.framework.TestCase" {
	...
	function createTaForYouTest() {

		ta = new model.beans.ta().init();
		debug(ta);

		/*ta.setPreparer(321333);*/
		/*ta.setId();*/
		/*ta.setCreated();*/
		/*ta.setUpdated();*/
		ta.setFk_userid(321333);
		ta.setFk_preparerid(321333);
		ta.setEe("yes");
		ta.setInstate("yes");
		ta.setPhysAddr("No");
		ta.setWarrantAddr("no");
		ta.setEin(321333);
		/*ta.setPvn();*/
		ta.setTravelerName("Jeremey P Hustman");
		ta.setTitle("Analyst/Programmer III");
		ta.setDept("Transportation & Public Facilities");
		ta.setDiv("DAS-STWD ADMIN INFO SYSTEMS");
		ta.setBu("GP");
		ta.setDutyStation("Juneau");
		/*ta.setHomeAddress();*/
		/*ta.setHomeCity();*/
		/*ta.setHomeState();*/
		/*ta.setHomeZip();*/
		ta.setWorkDays("M-F");
		ta.setWorkTime("8-4");
		ta.setDepartureFrom("Juneau");
		ta.setDepartureDate("04/24/2015");
		ta.setDestinationTo("Anchorage");
		ta.setReturnDate("04/29/2015");
		ta.setPurpose("Example Purpose");
		ta.setTravPref("Example preference.");
		ta.setHotelInc("yes");
		ta.setCarInc("yes");
...
<SOAP-ENV:Envelope
    ...
    <SOAP-ENV:Body>
        <idc:service
            ...
            <idc:document dPublishType="" dFormat="application/pdf" dRevisionID="1" dProcessingState="C" dSecurityGroup="Projects" dOriginalName="25-2015-00001-itzf1n.pdf" dDocType="Other" dWebExtension="pdf" dDocAuthor="jphustman" dRevLabel="1" dUser="jphustman" dPublishState="" dFileSize="0" dDocName="DOT-JNU_066013" dRevClassID="66013" dStatus="GENWWW" dOutDate="" dIsWebFormat="0" dLocation="" dID="67879" dCheckoutUser="" dReleaseState="E" dCreateDate="4/15/15 2:36 PM" dIsPrimary="1" dExtension="pdf" dDocTitle="25-2015-00001" dDocID="137066" dIsCheckedOut="0" dDocAccount="prj/PRJ0000028">
                ...
                <idc:field name="dRawDocID">137064</idc:field>
                <idc:field name="isCurRevEmpty"></idc:field>
                <idc:field name="dWfDocState">INPROCESS</idc:field>
                <idc:field name="VaultfilePath">/opt/stellent/vault/other/@prj/@prj0000028/67879.pdf</idc:field>
                ...
                <idc:field name="dActionMillis">472757991</idc:field>
                <idc:field name="latestCreateDate">{ts ''2015-04-15 14:35:11.224''}</idc:field>
                <idc:field name="xMilePost"></idc:field>
                <idc:field name="xProjectActivityNum"></idc:field>
                <idc:field name="dWfEntryTs">{ts ''2015-04-15 14:36:17.958''}</idc:field>
                ...
                <idc:field name="lastEntryTs">{ts ''2015-04-15 14:36:00.000''}</idc:field>
                ...
                <idc:field name="latestInDate">{ts ''2015-04-15 14:35:11.224''}</idc:field>
                ...
                <idc:field name="oldName">DOT-JNU_066013</idc:field>
                ...
                <idc:field name="dCurRevID">67879</idc:field>
                ...
                <idc:field name="dActionDate">4/15/15 2:36 PM</idc:field>
                ...
                <idc:field name="CurRevID">67879</idc:field>
                ...
                <idc:field name="wfQueueEnterTs">{ts ''2015-04-15 14:36:18.036''}</idc:field>
                ...
                <idc:field name="WebfilePath">/opt/stellent/weblayout/groups/projects/@prj/@prj0000028/documents/other/dot-jnu_066013~1.pdf</idc:field>
                ...
                <idc:field name="latestID">67879</idc:field>
                ...
                <idc:field name="primaryFile">/srv/http/eta/app/temp/25-2015-00001-itzf1n.pdf</idc:field>
                <idc:field name="xSupDate3:isSetDefault">1</idc:field>
                <idc:field name="dCollectionModifier">jphustman</idc:field>
                <idc:field name="dConvJobID">72142</idc:field>
                <idc:field name="xPrimaryParty3:isSetDefault">1</idc:field>
                <idc:field name="xDateIssued:isSetDefault">1</idc:field>
                <idc:field name="StatusMessage">Successfully checked in content item ''DOT-JNU_066013''.</idc:field>
                ...
                <idc:field name="dConvActionDate">4/15/15 2:36 PM</idc:field>
                ...
                <idc:field name="wfQueueLastActionTs">{ts ''2015-04-15 14:36:18.036''}</idc:field>
                ...
                <idc:field name="primaryFile:path">/opt/stellent/vault/~temp/439225473.pdf</idc:field>
                <idc:field name="xSupDate2Type:isSetDefault">1</idc:field>
                <idc:field name="xCity:isSetDefault">1</idc:field>
                <idc:field name="dConvStartDate">4/15/15 2:36 PM</idc:field>
		...
		debug(content);
		soapResponse = xmlParse(Trim(content));
		debug(soapResponse);
		/*searchString = writeDump(XMLSearch(soapResponse, "//*[local-name()='dWfName']"));*/
		debug(XMLSearch(content, "//*[local-name()='document' and namespace-uri()='http://www.stellent.com/IdcService/']"));
		debug(XMLSearch(soapResponse, "//*[local-name()='document' and namespace-uri()='http://www.stellent.com/IdcService/']"));
		/*debug(searchString);*/
