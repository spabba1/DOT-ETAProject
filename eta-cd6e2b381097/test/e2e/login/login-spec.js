...
describe('Should login', function () {
    var loginUrl, username = element(by.name("username")), password = element(by.name("password")), loginButton = element(by.id("sign-in")), logoutButton = element(by.id("logout")), error = element(by.model('login'));
